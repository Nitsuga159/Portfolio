  ...
  return (
    <>
      <Box className='projects-container' >
        <Typography variant='h2' className='projects-title' fontWeight='bolder'>
          Full Stack
        </Typography>
        <Typography className='description-projects'>
          Proyectos en los cuales involucro las tres partes esenciales de una página web: FrontEnd, BackEnd y DataBase, creando así una aplicación web desde cero.
        </Typography>
        ...
        <Typography className='description-projects'>
          Estos proyectos fueron desarrollados con el framework React. El objetivo de éstos fue experimentar y practicar con ésta librería, conocer el flujo de estados y componentes.
        </Typography>
        <Box className='cards-container'>
          {
              react.map((project, i) => (
        ...
        <Typography className='description-projects'>
          Proyectos los cuales involucran las tres tecnologías principales del FrontEnd. HTML para la estructura, CSS para el diseño y JavaScript para la lógica.
        </Typography>
        <Box className='cards-container'>
          {
              js.map((project, i) => (
        ...
        <Typography className='description-projects'>
          Proyectos en los cuales utilizo solamente HTML y CSS para entender cómo se relacionan y poner en practica las millones de propiedades para diseñar y estilizar una página web.
        </Typography>
        <Box className='cards-container'>
          {
              htmlAndCss.map((project, i) => (
                <Card 
                  key={i}
                  title={project.title} 
                  imgURL={project.imgURL}
